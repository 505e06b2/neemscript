...
class Neem {
	public:
		...
		Neem();
	private:
		enum types {none_, comment_, echo_, set_, prompt_, setsystem_, goto_, call_, inc_, fi_, if_, for_, rof_, sum_, label_, strftime_, sleep_, start_, pwd_, cd_, ls_, pause_, output_, input_, readall_, readline_, loadlib_, runlibfunc_, unloadlib_};
